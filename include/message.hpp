...
message::avim_message_packet decode_message(const std::string& encryption_key, const std::string& payload);

std::string encode_message(const message::avim_message_packet&);
std::string encode_message(const std::string& encryption_key, const message::avim_message_packet&);
